...
export class ProfessorEditComponent implements OnInit {
    ...
    private loadData(): void {
        ...
        this.coursService.getProfessorById(this.id).subscribe({
            next: (prof) => {
                ...
                // Load existing courses taught
                this.coursService.getCoursesByProfessor(this.id).subscribe(cList => {
            ...
            error: () => {
                this.error = 'Impossible de charger le professeur.';
                this.loading = false;
            }
        });
    }
    ...
    submit(): void {
        ...
        this.coursService.updateProfessor(this.id, payload).subscribe({
            next: () => {
